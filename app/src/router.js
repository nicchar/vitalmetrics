...
import { renderMyRecipes } from './ui/screens/myRecipes.js';
...
const TOOLS_SUBSCREENS = ['fasting', 'glucose_day', 'cravings', 'mealplan', 'weekly_review', 'skin_vitality', 'cycle_wellness', 'my_recipes'];
